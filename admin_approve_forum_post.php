    ...
    <div class="page-content">
    	<div class="row">
		  ...
		  <div class="col-md-10">
					...
					<table border="2" class="table table-striped table-hover">
						<thead>
						  <tr>
							  <th>Approve</th>
							  <th>Remove</th>
							  <th width=1080>Forwarded Post</th>
						  </tr>
						</thead>
			<?php
			...
			?>
						  <tr>
							  <td><input type='radio' name='action<?php[{$row['pf_id']}]?>' value='APP'></td>
							  <td><input type='radio' name='action<?php[{$row['pf_id']}]?>' value='DEL'></td>
							  <td><strong>Title :<?php echo $row['pf_title']; ?></strong>
							  <br><strong>Main Post :</strong><br><?php echo $row['pf_ppost'];?>
							  <br>&nbsp;&nbsp;(Submitted by <?php echo $row['pf_name'] . " on " . $row['pf_date']; ?>)</td>
						  </tr>
			<?php
			ENDWHILE; 
			?>
					</table>
					<input type='submit' name='submit_ap' value='Process'>
				</div>
			</form> 
